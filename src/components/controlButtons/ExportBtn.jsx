...
const ExportBtn = () => {
  ...
  return (
    ...
    <button onClick={() => {clickedForSetter('ExportToFile') && showPasswordPrompt()}} className="text-black font-bold hover:bg-yellow-600 bg-red-500 rounded px-2 py-1 my-2 sm:my-0">
      Back Up Now
    </button>
  )
}
