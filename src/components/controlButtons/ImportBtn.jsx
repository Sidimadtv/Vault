...
const ImportBtn = () => {
  ...
  return (
    ...
    <button onClick={() => {clickedForSetter('ImportFromFile') && showPasswordPrompt()}} className="text-white font-bold hover:bg-blue-700 bg-red-500 rounded px-4 py-1 my-2 sm:my-0">
      Restore a BackUp
    </button>
  )
}
